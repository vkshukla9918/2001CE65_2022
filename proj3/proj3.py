...
try:
    ...
    print('error in function useful_values_u()')
try:
    def useful_values_v():
    ...
    print('error in function useful_values_v()')
try:
    def useful_values_w():
    ...
    print('error in function useful_values_w()')
...
try:
    ...
    print('error in function useful_values()')
...
try:
    ...
    print('error in function fk (155-197)')
try:    
    def Q_K_Value():
    ...
    print('error in function Q_K_Value')
try:
    def octant_ID():
        data['Octant_id']=0
        for i in range(N):
    ...
    print('error in function octant ID')
...
try:
    ...
    print('error in function octant_column()')
...
try:
    ...
    print('error in function max_min_update(i,j)')
...
try:
    ...
    print('error in function octant')
try:
    def Acceleration_U():
        for i in range(N):
            if i==0:
    ...
    print('error in function Acceleration')
try:
    def find_std():
    ...
    print('error in fuction of finding standar mean and deviation')
...
try:
    ...
    print('error in accceleration functions')
...
try:
    ...
    print('error in corr or SNR function')
