...
for i in range(x-1):  #appending subsequences of a octant
    ...
    if(octact[i] == 2 and octact[i+1] == 2):
        c += 1
    elif((octact[i-1]!= 2 and octact[i] == 2 and octact[i+1] != 2) or (octact[0] == 2 and octact[1]!= 2)or (octact[x-2] != 2 and octact[x-1] == 2)):
        max2.append(1)
    else:
        if c>0:
            max2.append(c+1)
    ...
    if(octact[i] == 3 and octact[i+1] == 3):
        e += 1
    elif((octact[i-1]!= 3 and octact[i] == 3 and octact[i+1] != 3) or (octact[0] == 3 and octact[1]!= 3)or (octact[x-2] != 3 and octact[x-1] == 3)):
        max3.append(1)
    else:
        if e>0:
            max3.append(e+1)
    ...
    if(octact[i] == 4 and octact[i+1] == 4):
        g += 1
    elif((octact[i-1]!= 4 and octact[i] == 4 and octact[i+1] != 4) or (octact[0] == 4 and octact[1]!= 4)or (octact[x-2] != 4 and octact[x-1] == 4)):
        max4.append(1)
    else:
        if g>0:
            max4.append(g+1)
